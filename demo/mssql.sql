...
CREATE TABLE demo.outcome (
    ...
    sysmoment       datetime    NOT NULL DEFAULT GETDATE(),
...
INSERT INTO demo.project (client_id, project_name, deleted) VALUES
    (1, 'Alpha_Project_#01', 0),    -- #1
    (1, 'Alpha_Project_#02', 1),    -- #2
    (1, 'Alpha_Project_#03', 0),    -- #3
    (2, 'Beta_Project_#01', 1),     -- #4
    (2, 'Beta_Project_#02', 1),     -- #5
    (2, 'Beta_Project_#03', 0),     -- #6
    (2, 'Beta_Project_#04', 0),     -- #7
    (2, 'Beta_Project_#05', 0),     -- #8
    (4, 'Delta_Project_#01', 0),    -- #9
    (4, 'Delta_Project_#02', 0),    -- #10
    (4, 'Delta_Project_#03', 1);    -- #11
